...
export default function Filter() {
  ...
  return (
    <Drawer
      ...
      slotProps={{
        paper: {
          sx: { height: "calc(100vh - 64px)", width: "50vw", mt: "74px", borderRadius: "22px 0px 0px 0px", border: "1px solid rgba(255, 101, 1, 0.5)", pb: 4 }
        }
      }}
    >
      {/* HEADER */}
      <Box sx={{ px: 4, py: 2, borderBottom: "1px solid rgba(255, 101, 1, 0.5)", display: "flex", justifyContent: "space-between" }}>
        <Box>
          <Typography sx={{ fontSize: "22px", fontWeight: 600 }}>Filters</Typography>
      ...
      <Box sx={{ px: 4, py: 2 }}>
        ...
        {/* Country */}
        <Box sx={{ mb: 2 }}>
          <Typography sx={{ fontSize: "16px", fontWeight: 500, fontStyle: "medium", mb: 2, color: "#1E1E1E", }}>Country</Typography>
        ...
        {/*Profession */}
        <Box sx={{ mb: 2 }}>
          <Typography sx={{ fontSize: "16px", fontWeight: 500, mb: 2, color: "#1E1E1E", }}>Profession</Typography>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1, }}>
            <Chip sx={{
              bgcolor: "#F4F4F4", py: 2.5, borderRadius: "8px",
              color: "#717579", fontSize: "14px", fontWeight: 500,
        ...
        {/* Last Engagement */}
        <Box sx={{ mb: 2 }}>
          <Typography sx={{ fontSize: "16px", fontWeight: 500, mb: 2, color: "#1E1E1E", }}>Last Engagement</Typography>
          <Box sx={{ display: "flex",  alignItems: "center", gap: 1, }}>
            <Chip sx={{
              bgcolor: "#F4F4F4", py: 2.5, borderRadius: "8px",
              color: "#717579", fontSize: "14px", fontWeight: 500,
        ...
        <Box sx={{ display: "flex", gap: 3 }}>
          {[
            ...
            <FormControl key={i} size="small" sx={{ minWidth: 110 }}>
              <Select
                value={value}

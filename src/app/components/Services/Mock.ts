export const names = ["Beru", "Asta", "Sung Jin Woo", "Igris", "Tank"];
export const professions= ["Doctor 46/M", "Doctor 47/M", "Doctor 48/M", "Doctor 49/M", "Doctor 50/M"];
export const groupsList = ["VIP Groups", "Main Groups", "3 Groups", "4 Groups", "5 Groups"];
export const mbCt = ["c1", "c2", "c3", "c4", "c5"];
...
export const dates = ["15 Dec 2025", "14 Aug 2025", "13 Jun 2025", "12 Jun 2025", "11 Dec 2025"];
